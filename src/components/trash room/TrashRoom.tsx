...
function TrashRoom(): JSX.Element {
    ...
    return (
        <>
            ...
            { (thoughts.length > 0 && !showThoughtContainer) ? <Button sx={{ margin: 2, textTransform: 'none' }} onClick={deleteAllThoughts} color="success">Ease my mind</Button> : <></> }
            { !showThoughtContainer ? <Button sx={{ margin: 2, textTransform: 'none' }} variant="contained" onClick={showField}>I want to share something</Button> : <></> }
